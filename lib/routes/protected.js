...
(function () {
    ...
    var loggerRoutes = require('../modules/logger/loggerRoutes');
    var boardRoutes = require('../modules/boards/boardRoutes');
    ...
    router = loggerRoutes.appendProtectedRoutes(router);
    router = boardRoutes.appendProtectedRoutes(router);
